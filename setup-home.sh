...
# --- Fix the NVIDIA "ghost"/stuck second cursor -----------------------------
# NVIDIA + Wayland renders a stale cursor on the hardware plane while the real
# one moves in software. Disabling the HW cursor plane removes the ghost.
cursor {
...
chmod +x "$BIN/select-monitors.sh" "$BIN/hdr-toggle" "$BIN/ros2-jazzy"
